...
Exemple : iPhone 1 → iPhone 2 → iPhone 3 (chaque modèle remplace le précédent)|Exemple : En 2025, nous utilisons simultanément<br>Vague 1 : Systèmes de contrôle aérien (règles de sécurité critiques)<br>Vague 2 : Reconnaissance faciale, traduction automatique<br>Vague 3 : Véhicules autonomes (en R&D)
...
1. Prescription : orienter la recherche vers la vague 3
1. Financement : justifier $2 milliards pour l'initiative "AI Next"
...
Problème : La réalité est plus granulaire
...
2. Biais téléologique
Problème : Présuppose que la vague 3 est "supérieure"
...
3. Construction rétrospective
Problème : Les "vagues 1 et 2" n'ont pas été conçues comme telles
...
* Nuance : Cela n'invalide pas l'utilité analytique du cadre
## **Synthèse conceptuelle : qu'est-ce qu'une vague vraiment ?**
Une vague de l'IA est :
1. Un paradigme scientifique au sens de Kuhn (ensemble cohérent d'hypothèses, méthodes, et problèmes)
1. Une phase technologique avec son cycle d'innovation (émergence → maturité → limites → nouvelle vague)
1. Un outil de politique scientifique pour orienter financement et recherche
1. Une simplification didactique de l'histoire complexe de l'IA
### **Analogie complète : Les vagues de l'IA sont comme les couches géologiques**
...
Exercice : ChatGPT est-il vague 2 ou 3 ?
Réponse : Principalement vague 2 (apprentissage statistique massif), avec des éléments proto-vague 3 (capacité d'explication rudimentaire, apprentissage in-context)
## En conclusion
